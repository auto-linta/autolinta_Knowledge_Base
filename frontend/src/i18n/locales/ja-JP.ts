export default {
  ...
  "collapse": "折りたたむ",
  "expand": "展開",
  "leaveHint": "アプリ内のページ移動中もアップロードを続けます。再読み込みや終了で中断します。再選択時は重複を確認します。",
  "total": "{count} ファイル",
  "queued": "前のバッチの完了待ち",
  "checkingHint": "指紋を確認中 {count}/{total}。確認後にアップロード開始",
  "progress": "バッチの進捗",
  "receivedCount": "アップロード済み {count}",
  "duplicateCount": "重複拒否 {count}",
  "failedCount": "失敗・未確認 {count}",
  "cancelledCount": "停止 {count}",
  "removedCount": "削除済み {count}",
  "stop": "アップロード停止",
  "retry": "確認して再試行",
  "rollback": "このバッチを取り消す",
  "rollbackConfirm": "このバッチで作成が確認された {count} 件を削除しますか？既存の重複文書と結果未確認のリクエストは対象外です。",
  "dismiss": "記録を閉じる",
  "files": "ファイルの状態",
  "parsing": "解析：",
  "statusUnknown": "状態未確認",
  "batchDuplicate": "バッチ内で内容が重複しているため拒否しました。",
  "serverDuplicate": "同じ内容・種類のファイルが存在するため拒否しました。",
  "uncertainHint": "リクエストは中断されましたが、受信済みの可能性があります。再試行前に重複を確認します。",
  "preflightFailed": "事前確認に失敗したためアップロードを続行しません。",
  "statusUnavailable": "解析状態を取得できません。後で再試行します。",
  "rollbackFailed": "一部の削除が失敗しました。再確認して取り消してください。",
  "rollbackPending": "削除の確認が未完了です。再度取り消すと残りを確認します。",
  "state": {
    "waiting": "確認待ち",
    "checking": "重複確認中",
    "uploading": "アップロード中",
