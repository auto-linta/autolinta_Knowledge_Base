export default {
  ...
  "collapse": "收起",
  "expand": "展开",
  "leaveHint": "切换应用内页面可继续上传。刷新或关闭页面会中断队列；再次选择文件会先检查重复。",
  "total": "共 {count} 个文件",
  "queued": "等待上一批上传结束",
  "checkingHint": "检查文件指纹 {count}/{total}，检查完成后开始上传",
  "progress": "批次进度",
  "receivedCount": "已上传 {count}",
  "duplicateCount": "拒绝重复 {count}",
  "failedCount": "失败 / 待核实 {count}",
  "cancelledCount": "已停止 {count}",
  "removedCount": "已撤销 {count}",
  "stop": "停止上传",
  "retry": "检查后重试",
  "rollback": "撤销本批已上传文件",
  "rollbackConfirm": "将删除本批确认新建的 {count} 份文档。已有重复文档不会删除；结果待核实的请求不包含在内。",
  "dismiss": "移除任务记录",
  "files": "逐文件状态",
  "parsing": "解析：",
  "statusUnknown": "状态待确认",
  "batchDuplicate": "本批文件内容重复，已拒绝。",
  "serverDuplicate": "知识库中已有相同内容和类型的文件，已拒绝。",
  "uncertainHint": "请求已中断，服务器可能已接收；重试前会核实重复。",
  "preflightFailed": "预检失败，未继续上传。",
  "statusUnavailable": "暂时无法刷新解析状态，稍后自动重试。",
  "rollbackFailed": "部分文件删除失败，请再次核实并撤销。",
  "rollbackPending": "删除尚未全部确认。再次点击撤销会先核实剩余文件。",
  "state": {
    "waiting": "等待检查",
    "checking": "检查重复",
    "uploading": "上传中",
