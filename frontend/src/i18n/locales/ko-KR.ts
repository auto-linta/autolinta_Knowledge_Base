export default {
  ...
  "collapse": "접기",
  "expand": "펼치기",
  "leaveHint": "앱 내 페이지를 이동해도 업로드는 계속됩니다. 새로고침하거나 닫으면 중단되며, 다시 선택하면 중복을 먼저 확인합니다.",
  "total": "파일 {count}개",
  "queued": "이전 배치 완료 대기",
  "checkingHint": "지문 확인 {count}/{total}; 확인 후 업로드 시작",
  "progress": "배치 진행률",
  "receivedCount": "업로드됨 {count}",
  "duplicateCount": "중복 거부 {count}",
  "failedCount": "실패 / 미확인 {count}",
  "cancelledCount": "중지됨 {count}",
  "removedCount": "삭제됨 {count}",
  "stop": "업로드 중지",
  "retry": "확인 후 재시도",
  "rollback": "이 배치 취소",
  "rollbackConfirm": "이 배치에서 생성이 확인된 문서 {count}개를 삭제할까요? 기존 중복 문서와 결과가 미확인인 요청은 제외됩니다.",
  "dismiss": "기록 닫기",
  "files": "파일 상태",
  "parsing": "분석: ",
  "statusUnknown": "상태 미확인",
  "batchDuplicate": "배치 내 내용 중복으로 거부되었습니다.",
  "serverDuplicate": "같은 내용과 유형의 파일이 있어 거부되었습니다.",
  "uncertainHint": "요청이 중단되었지만 서버가 받았을 수 있습니다. 재시도 전에 중복을 확인합니다.",
  "preflightFailed": "사전 확인에 실패하여 업로드를 계속하지 않았습니다.",
  "statusUnavailable": "분석 상태를 갱신할 수 없습니다. 잠시 후 재시도합니다.",
  "rollbackFailed": "일부 삭제에 실패했습니다. 확인 후 다시 취소하세요.",
  "rollbackPending": "삭제가 모두 확인되지 않았습니다. 다시 취소하면 남은 문서를 확인합니다.",
  "state": {
    "waiting": "대기",
    "checking": "중복 확인 중",
    "uploading": "업로드 중",
