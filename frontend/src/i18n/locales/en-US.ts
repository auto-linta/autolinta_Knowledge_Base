export default {
  ...
  "collapse": "Collapse",
  "expand": "Expand",
  "leaveHint": "Uploads continue across app pages. Reloading or closing interrupts the queue; selecting files again checks for duplicates first.",
  "total": "{count} files",
  "queued": "Waiting for the previous batch",
  "checkingHint": "Checking fingerprints {count}/{total}; uploading starts after checks",
  "progress": "Batch progress",
  "receivedCount": "Uploaded {count}",
  "duplicateCount": "Duplicates rejected {count}",
  "failedCount": "Failed / unconfirmed {count}",
  "cancelledCount": "Stopped {count}",
  "removedCount": "Removed {count}",
  "stop": "Stop uploads",
  "retry": "Check and retry",
  "rollback": "Undo this batch",
  "rollbackConfirm": "Delete the {count} documents confirmed created by this batch? Existing duplicates and requests with unconfirmed results are excluded.",
  "dismiss": "Dismiss record",
  "files": "File status",
  "parsing": "Parsing: ",
  "statusUnknown": "Status unconfirmed",
  "batchDuplicate": "Duplicate content in this batch; rejected.",
  "serverDuplicate": "The knowledge base already contains this content and file type; rejected.",
  "uncertainHint": "Request interrupted; the server may have received it. Retry checks for duplicates first.",
  "preflightFailed": "Preflight failed; upload did not continue.",
  "statusUnavailable": "Unable to refresh parsing status. Retrying shortly.",
  "rollbackFailed": "Some deletions failed. Check and undo again.",
  "rollbackPending": "Deletion is not fully confirmed. Undo again to reconcile remaining documents.",
  "state": {
    "waiting": "Waiting",
